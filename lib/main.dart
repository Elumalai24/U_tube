...
import 'package:youtube/about.dart';
import 'package:youtube/favorite.dart';
import 'package:youtube/home.dart';
import 'package:youtube/playlist.dart';
...
class _MyAppState extends State<MyApp> {
  showdialog(BuildContext, context, String message, String contents) {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
  ...
  showdialog2(BuildContext, content) {
    return showDialog(
        context: context,
    ...
    return MaterialApp(
        ...
        home: DefaultTabController(
          ...
          child: Scaffold(
              ...
              child: ListView(
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      showdialog(BuildContext, context, 'Channel Description',
                          'Hi this is my second channel name is Lotus. You can get any videos and clear doubts using any comment box of any videos. Just subscribe this channeland ask for your doubts.\n\nThanks for your suport');
                    },
                  ),
                  ListTile(
                    title: Container(
                  ...
                  ListTile(
                    title: Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.thumb_up, color: Colors.black12, size: 30),
                          SizedBox(
                            width: 20,
                          ),
                          Text(
            ...
            body:
                TabBarView(children: [Home(), Playlist(), Favorite(), About()]),
          ),
        ));
  }
}
